...
<body>
  <div class="iframecontent">
    ...
    <div class="operate">
      <div class="pull-left">
        <input type="button" name="" value="添加" class="btn  btn-success" onclick="addVideo()">
      </div>
      <!-- operate标题结束 -->
      <div class="list">
        <div class="tablewrap">
          <table class="table" width="100%" id="datalist">
            ...
            <tbody>
              <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr id="video<?php echo ($vo["id"]); ?>">
                  <td><?php echo ($vo["id"]); ?></td>
                  <td><?php echo ($vo["title"]); ?></td>
                  <td><?php echo ($vo["addtime"]); ?></td>
                  <td style="max-width: 300px;"><?php echo ($vo["src"]); ?></td>
                  <td>
                    <a href="javascript:;" onclick="delVideo(<?php echo ($vo["id"]); ?>)">删除</a>
                  </td>
