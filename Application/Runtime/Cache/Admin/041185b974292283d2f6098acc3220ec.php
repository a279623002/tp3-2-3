...
<body>
	<div class="login">
		<div class="loginmain">
			<h2>登录管理系统</h2>
			<form action="<?php echo U('checkLogin','','');?>" method="POST" class="form-horizontal">
				...
				<div class="form-group">
					<div class="col-lg-11 col-lg-offset-1">
						<span class="checkbox ">
							<label>
								<input type="checkbox" name="" class="checkbox-inline">记住我</label>
						</span>
					</div>
				</div>
	...
	<script src="/Public/js/b_login.js"></script>
</body>
