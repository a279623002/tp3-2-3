...
<head>
  ...
  <link href="/tp3-2-3/Public/css/style.css" rel="stylesheet" type="text/css" />
  <script type="text/javascript" src="/tp3-2-3/Public/js/jquery-1.7.2.min.js"></script>
  <script src="/tp3-2-3/Public/js/common.js" type="text/javascript"></script>
...
<body class="body_product">
  ...
  <div id="footer">
    ...
    <div id="guide" onClick="closeGuide()">
      <img src="/tp3-2-3/Public/images/guide.png" />
    </div>
    <!-- 微信分享导引 结束-->
    <!--快捷按钮 开始-->
    <div class="plug-div">
      <div class="plug-phone">
        ...
        <div class="themeStyle plug-btn plug-btn1 close">
          <a href="/">
            <span style="background-image: url(/tp3-2-3/Public/ky_img/home.png);"></span>
          </a>
        </div>
        <div class="themeStyle plug-btn plug-btn2 close">
          <a href="<?php echo U('contact');?>">
            <span style="background-image: url(/tp3-2-3/Public/ky_img/tel.png);"></span>
          </a>
        </div>
        <div class="themeStyle plug-btn plug-btn3 close">
          <a href="<?php echo U('about');?>">
            <span style="background-image: url(/tp3-2-3/Public/ky_img/aboutus.png);"></span>
          </a>
        </div>
      </div>
    </div>
    ...
    <div>
      <ul class="wxlist">
        <a href="#top">
          <li>
            <div class="GoTop">
              <img src="/tp3-2-3/Public/images/top.png" />回顶部
            </div>
          </li>
        </a>
      </ul>
