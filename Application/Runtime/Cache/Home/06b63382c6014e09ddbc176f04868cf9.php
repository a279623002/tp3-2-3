        ...
        <div style="margin-bottom:55px;">
            <div id="toolbar">
                <div class="fixed-green">
                    ...
                    <a class="ui-btn-home" href="http://2040.wangzhan31.com/wap"></a>
                </div>
            </div>
            <div id="overlay"></div>
            <div id="window">
                                ...
                                <span style="font-family: 微软雅黑">
                                    <span style="color: rgb(255,140,0)">
                                        <span style="font-size: 16px">
                                            <span style="font-family: 微软雅黑">
                                                <span style="color: rgb(255,140,0)">
                                                    <span style="font-family: 微软雅黑; color: rgb(255,140,0); font-size: 16px">&nbsp;&nbsp; </span>某某
                                                    <span style="font-family: 微软雅黑; color: rgb(255,140,0); font-size: 16px">陶瓷有限公司</span>
                                                </span>
                                            </span>
                                        </span>
                                    </span>
                                            ...
                                            <span style="font-size: 16px">
                                                <span style="font-family: 微软雅黑">
                                                    <span style="color: rgb(255,140,0)">
                                                        <span style="font-size: 16px">
                                                            <span style="font-family: 微软雅黑">
                                                                <span style="color: rgb(255,140,0)">　地址：北京市海淀区学院路春天花园8栋906</span>
                                                            </span>
                                                        </span>
                                                    </span>
                                                </span>
                                            ...
                                            <span style="font-size: 16px">
                                                <span style="font-family: 微软雅黑">
                                                    <span style="color: rgb(255,140,0)">
                                                        <span style="font-size: 16px">
                                                            <span style="font-family: 微软雅黑">
                                                                <span style="color: rgb(255,140,0)">　电话：010－88888888</span>
                                                            </span>
                                                        </span>
                                                    </span>
                                                </span>
                                            ...
                                            <span style="font-size: 16px">
                                                <span style="font-family: 微软雅黑">
                                                    <span style="color: rgb(255,140,0)">
                                                        <span style="font-size: 16px">
                                                            <span style="font-family: 微软雅黑">
                                                                <span style="color: rgb(255,140,0)">　网址：http://www.xxxx.com
                                                                    <br />
    ...
    <div id="footer">
        ...
        <div class="tool">
            <table border="0">
                <tr>
                    <td>
                        <a class="btn" onclick="openGuide()">
                            <img src="images/send.png" width="32px" align="absmiddle" />发给朋友</a>
                    </td>
                    <td>
                        <a class="btn" onClick="openGuide()">
                            <img src="images/friend.png" width="32px" align="absmiddle" />分享到朋友圈</a>
                    </td>
                </tr>
            </table>
        </div>
        <div>
            <ul class="wxlist">
                <a href="#top">
                    <li>
                        <div class="GoTop">
                            <img src="/Public/images/top.png" />回顶部</div>
                    </li>
                </a>
            </ul>
        </div>
        <div class="copyright">
            这里是底部信息
            <br>免责声明：所有资源仅供学习与参考，版权归原作者，请勿用于商业用途，否则产生的一切后果将由您自行承担，与小贝壳模板无关。
        </div>
    </div>
    <!--页脚结束-->
</body>
