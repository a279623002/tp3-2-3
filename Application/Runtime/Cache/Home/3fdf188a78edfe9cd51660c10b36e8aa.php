...
<body>
        ...
        <div style="margin-bottom:55px;">
            <div id="toolbar">
                <div class="fixed-green">
                    <a class="ui-title" id="popmenu">宣传视频</a>
        ...
        <div class="video">
            <ul class="wxlist">
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><li>
                        ...
                        <div class="InfoTime"><?php echo ($vo["addtime"]); ?></div>
                        <div class="InfoSContent"></div>
                        <div class="InfoContent">
                            <div>
                                <iframe height="450px" width="100%" src="<?php echo ($vo["src"]); ?>" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
    ...
    <div id="footer">
        ...
        <div id="guide" onclick="closeGuide()">
            <img src="/App/Tpl/Wap/Default/Public/images/guide.png">
        </div>
        <!-- 微信分享导引 结束-->
        <!--快捷按钮 开始-->
        <div class="plug-div">
